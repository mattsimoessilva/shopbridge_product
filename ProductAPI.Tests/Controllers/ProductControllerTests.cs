    ...
    public class ProductControllerTests
    {
        ...
        public async Task GetAllMethod_ShouldReturnOkWithProductList()
        {
            ...
            var products = new List<ProductReadDTO>
            {
                ...
                new() { Id = Guid.NewGuid(), Name = "Mechanical Keyboard", ShortDescription = "RGB mechanical keyboard", FullDescription = "High-performance mechanical keyboard with customizable RGB lighting.", Price = 349.99m, DiscountPrice = 299.99m, IsActive = true, IsFeatured = false, SKU = "MK-002", StockQuantity = 80, MinimumStockThreshold = 5, AllowBackorder = true, Brand = "Corsair", Category = "Accessories", Tags = "keyboard,mechanical,RGB", ImageUrl = "/images/products/mechanical-keyboard.jpg", ThumbnailUrl = "/images/products/thumbs/mechanical-keyboard.jpg", SeoTitle = "Mechanical Keyboard - RGB & Performance", SeoDescription = "Upgrade your setup with the Corsair Mechanical Keyboard — built for peak performance.", Slug = "mechanical-keyboard", CreatedAt = DateTime.UtcNow, UpdatedAt = null, Variants = new List<ProductVariantReadDTO>(), Reviews = new List<ProductReviewReadDTO>() }
            };
        ...
        {
            // Arrange
            var dto = new ProductUpdateDTO { Id = Guid.NewGuid(), Name = "Nonexistent Product", ShortDescription = "Nonexistent.", FullDescription = "Nonexistent.", Price = 129.99m, DiscountPrice = 99.99m, IsActive = true, IsFeatured = true, StockQuantity = 150, MinimumStockThreshold = 10, AllowBackorder = false, Brand = "LogiTech", Category = "Accessories", Tags = "mouse,wireless,ergonomic", ImageUrl = "/images/products/nonexistent.jpg", ThumbnailUrl = "/images/products/thumbs/nonexistent.jpg", SeoTitle = "Nonexistent - Ergonomic & Silent", SeoDescription = "Discover the Nonexistent.", Slug = "non-existent" };
