    ...
    public static class DbInitializer
    {
        public static void Initialize(ProductAppDbContext context)
        {
            ...
            var products = new[] {
                ...
                new Product { Id = Guid.Parse("33333333-cccc-4444-dddd-333333333333"), Name = "Gaming Headset", ShortDescription = "Surround sound headset", FullDescription = "Immersive 7.1 surround sound gaming headset with noise-canceling mic.", Price = 249.99m, DiscountPrice = 199.99m, IsActive = true, IsFeatured = true, SKU = "GH-003", StockQuantity = 120, MinimumStockThreshold = 15, AllowBackorder = false, Brand = "Razer", Category = "Audio", Tags = "headset,gaming,surround", ImageUrl = "/images/products/gaming-headset.jpg", ThumbnailUrl = "/images/products/thumbs/gaming-headset.jpg", SeoTitle = "Gaming Headset - Surround Sound", Slug = "gaming-headset", CreatedAt = DateTime.UtcNow, UpdatedAt = null, Variants = new List<ProductVariant>(), Reviews = new List<ProductReview>() },
            };
