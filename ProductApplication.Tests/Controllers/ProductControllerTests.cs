...
namespace ProductApplication.Tests.Controllers
{
    public class ProductControllerTests
    {
        ...
        {
            // Arrange
            var dto = new ProductUpdateDTO { Id = Guid.NewGuid(), Name = "Wireless Mouse", ShortDescription = "Ergonomic wireless mouse", FullDescription = "Comfortable wireless mouse with adjustable DPI and silent clicks.", Price = 129.99m, DiscountPrice = 99.99m, IsActive = true, IsFeatured = true, MinimumStockThreshold = 10, AllowBackorder = false, Brand = "LogiTech", Category = "Accessories", Tags = "mouse,wireless,ergonomic", ImageUrl = "/images/entities/wireless-mouse.jpg", ThumbnailUrl = "/images/entities/thumbs/wireless-mouse.jpg", SeoTitle = "Wireless Mouse - Ergonomic & Silent", Slug = "wireless-mouse" };
            var updated = new ProductReadDTO { Id = dto.Id, Name = dto.Name, ShortDescription = dto.ShortDescription, FullDescription = dto.FullDescription, Price = dto.Price, DiscountPrice = dto.DiscountPrice, IsActive = dto.IsActive, IsFeatured = dto.IsFeatured, SKU = "WM-001", MinimumStockThreshold = dto.MinimumStockThreshold, AllowBackorder = dto.AllowBackorder, Brand = dto.Brand, Category = dto.Category, Tags = dto.Tags, ImageUrl = dto.ImageUrl, ThumbnailUrl = dto.ThumbnailUrl, SeoTitle = dto.SeoTitle, Slug = dto.Slug, Variants = new List<ProductVariantReadDTO>(), Reviews = new List<ProductReviewReadDTO>() };
        ...
        {
            // Arrange
            var dto = new ProductUpdateDTO { Id = Guid.NewGuid(), Name = "Nonexistent Product", ShortDescription = "Nonexistent.", FullDescription = "Nonexistent.", Price = 129.99m, DiscountPrice = 99.99m, IsActive = true, IsFeatured = true, MinimumStockThreshold = 10, AllowBackorder = false, Brand = "LogiTech", Category = "Accessories", Tags = "mouse,wireless,ergonomic", ImageUrl = "/images/entities/nonexistent.jpg", ThumbnailUrl = "/images/entities/thumbs/nonexistent.jpg", SeoTitle = "Nonexistent - Ergonomic & Silent", Slug = "non-existent" };
        ...
        public async Task ReduceStock_ShouldReturnOk_WhenReductionSucceeds()
        {
            // Arrange
            var id = Guid.NewGuid();
            var dto = new ProductStockUpdateDTO { Quantity = 2 };
