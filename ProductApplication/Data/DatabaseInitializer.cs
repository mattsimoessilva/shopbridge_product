...
namespace ProductApplication.Data
{
    public static class DatabaseInitializer
    {
        public static void Initialize(DatabaseContext context)
        {
            ...
            var products = new[] {
                new Product { Id = Guid.Parse("11111111-aaaa-4444-bbbb-111111111111"), Name = "Wireless Mouse", ShortDescription = "Ergonomic wireless mouse", FullDescription = "Comfortable wireless mouse with adjustable DPI and silent clicks.", Price = 129.99m, DiscountPrice = 99.99m, IsActive = true, IsFeatured = true, SKU = "WM-001", StockQuantity = 150, ReservedStockQuantity = 2, MinimumStockThreshold = 10, AllowBackorder = false, Brand = "LogiTech", Category = "Accessories", Tags = "mouse,wireless,ergonomic", ImageUrl = "/images/products/wireless-mouse.jpg", ThumbnailUrl = "/images/products/thumbs/wireless-mouse.jpg", SeoTitle = "Wireless Mouse - Ergonomic & Silent", Slug = "wireless-mouse", CreatedAt = DateTime.UtcNow, UpdatedAt = null, Variants = new List<ProductVariant>(), Reviews = new List<ProductReview>() },
                new Product { Id = Guid.Parse("22222222-bbbb-4444-cccc-222222222222"), Name = "Mechanical Keyboard", ShortDescription = "RGB mechanical keyboard", FullDescription = "High-performance mechanical keyboard with customizable RGB lighting.", Price = 349.99m, DiscountPrice = 299.99m, IsActive = true, IsFeatured = false, SKU = "MK-002", StockQuantity = 80, ReservedStockQuantity = 1, MinimumStockThreshold = 5, AllowBackorder = true, Brand = "Corsair", Category = "Accessories", Tags = "keyboard,mechanical,RGB", ImageUrl = "/images/products/mechanical-keyboard.jpg", ThumbnailUrl = "/images/products/thumbs/mechanical-keyboard.jpg", SeoTitle = "Mechanical Keyboard - RGB & Performance", Slug = "mechanical-keyboard", CreatedAt = DateTime.UtcNow, UpdatedAt = null, Variants = new List<ProductVariant>(), Reviews = new List<ProductReview>() },
                new Product { Id = Guid.Parse("33333333-cccc-4444-dddd-333333333333"), Name = "Gaming Headset", ShortDescription = "Surround sound headset", FullDescription = "Immersive 7.1 surround sound gaming headset with noise-canceling mic.", Price = 249.99m, DiscountPrice = 199.99m, IsActive = true, IsFeatured = true, SKU = "GH-003", StockQuantity = 120, ReservedStockQuantity = 3, MinimumStockThreshold = 15, AllowBackorder = false, Brand = "Razer", Category = "Audio", Tags = "headset,gaming,surround", ImageUrl = "/images/products/gaming-headset.jpg", ThumbnailUrl = "/images/products/thumbs/gaming-headset.jpg", SeoTitle = "Gaming Headset - Surround Sound", Slug = "gaming-headset", CreatedAt = DateTime.UtcNow, UpdatedAt = null, Variants = new List<ProductVariant>(), Reviews = new List<ProductReview>() },
            };
